      ...
      <div className="flex flex-col gap-4 ">
        ...
        <div className="mt-8 max-w-3xl bg-[#1f2937]/70 p-6 rounded-xl shadow-lg backdrop-blur text-sm leading-relaxed text-gray-200">
          ...
          <p>
            ...
            explorar ruinas antiguas, luchar contra dragones, resolver misterios
            o tomar decisiones morales. Las acciones se resuelven mediante el
            lanzamiento de dados, especialmente uno de 20 caras (d20), y se
            combinan con reglas del manual, pero también con mucha
            improvisación.
          </p>
          <br />
          <p>
            Una de las claves del juego es la narración colaborativa: no hay un
            “ganador”, sino que todos construyen una historia juntos. Los
          ...
          <p>
            ...
            compartida, donde lo más importante no es seguir reglas al pie de la
            letra, sino vivir grandes historias con amigos.
          </p>
        </div>
      </div>
    </div>
